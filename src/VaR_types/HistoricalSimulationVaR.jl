...
A naive Historical Simulation approach in which the VaR estimates is the corresponding quantile of
...
function predict(vm::HistoricalSimulationVaR{T}, X::AbstractVector) where T
    -quantile(X,vm.αs)
end
